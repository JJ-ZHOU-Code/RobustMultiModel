...
parser.add_argument('--generator',		 action='store_true', default=True, help='Use generator.')
parser.add_argument('--g_model_type',		 type=str,  default='ldvae', help='Type of generator.(vanilla, ldvae)')
parser.add_argument('--g_condition',	action='store_true', default=True, help='Use condition.') 
