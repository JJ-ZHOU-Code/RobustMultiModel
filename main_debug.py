...
data_root_dir = f'/home/zjj/zjj/data/TCGA/{dataset}/ExpData/feats-l1-s256-{feature_extractor}'
...
parser.add_argument('--feature_extractor',   type=str, default=feature_extractor,
...
parser.add_argument('--split_dir',       type=str, default=f'tcga_{dataset}',
...
### Model Parameters.
parser.add_argument('--model_type',      type=str, choices=['mcat', 'survpath'], 
...
parser.add_argument('--wsi_encoding_dim',type=int, default=wsi_encoding_dim, help='wsi encoding dim.')
parser.add_argument('--fusion',          type=str, choices=['None', 'concat'], default='concat', help='Type of fusion. (Default: concat).')
parser.add_argument('--generator',		 action='store_true', default=True, help='Use vae.')
parser.add_argument('--g_model_type',		 type=str,  default='ldvae', help='Type of VAE.(vanilla, vanilla_fusion, Transformer)')
parser.add_argument('--g_condition',	action='store_true', default=True, help='Use vae condition.') 
parser.add_argument('--decoder_mode',	 type=str,  default='specific', help='Type of decoder mode.(specific, shared)')
